								...
								<div class="row"  id="back">
									<div class="twelve columns">
										<?php
											...
											else if(isset($_GET['ViewSta']) && $_GET['ViewSta'] == "View")
											{
												require('AccountManagement/ViewFaculty.php');
											}
											else if(isset($_GET['Report']) && $_GET['Report'] == "Logs")
											{
												require('ReportManagement/Logs.php');
											}
											else if(isset($_GET['Subject']) && $_GET['Subject'] == "Subject")
											{
												require('Subject Management/Subject.php');
											}
											else if(isset($_GET['LOADING']) && $_GET['LOADING'] == "LOADING")
											{
												require('Subject Management/instructorload.php');
											}
											else if(isset($_GET['Mysub']) && $_GET['Mysub'] == "Mysub")
											{
												require('Subject Management/viewsubject.php');
											}
											else if(isset($_GET['viewall']) && $_GET['viewall'] == "Subject")
											{
												require('Subject Management/instructorsubject.php');
											}
											else if(isset($_GET['studsub']) && $_GET['studsub'] == "Subject")
											{
												require('Subject Management/studentsubject.php');
											}
											else if(isset($_GET['enroll']) && $_GET['enroll'] == "Subject")
											{
												require('Subject Management/enroll.php');
											}
											else if(isset($_GET['approval']) && $_GET['approval'] == "Subject")
											{
												require('Subject Management/approvesubject.php');
											}
											else if(isset($_GET['AddSub']) && $_GET['AddSub'] == "Subject")
											{
												require('Subject Management/AddSubject.php');
											}
											else if(isset($_GET['ViewSubj']) && $_GET['ViewSubj'] == "Subject")
											{
												require('Subject Management/subjects.php');
											}
											else if(isset($_GET['Sem']) && $_GET['Sem'] == "Semester")
											{
												require('Subject Management/semester.php');
											}
											?>
									</div>
								</div>
...
require('AccountManagement/CSV.php');
require('Subject Management/AddSem.php');
require('Subject Management/AddSubject.php');
?>
